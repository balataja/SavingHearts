...
public class BarPlot extends Activity {
      ...
      // insertActivity();
        ...
        if(db.getActivityDataCount() !=0){
	       ...
	       */
	        ...
	        while(datesize2!=0){
	        	if(Integer.parseInt(xDates.get(l2)) == datesMETs.get(m2)){
	        		maxMETs.add(dateMETs.get(datesMETs.get(m2)));
	        		m2++;
	        	}else{
	        		maxMETs.add(0.0);
	        	}
	      ...
	      //match the dates for calories
	        ...
	        while(datesize3!=0){
	        	if(Integer.parseInt(xDates.get(l3)) == datesCalories.get(m3)){
	        		maxCalories.add(dateCalories.get(datesCalories.get(m3)));
	        		m3++;
	        	}else{
	        		maxCalories.add(0.0);
	        	}
	      ...
	      //get y for Calories
	        ...
	        mRenderer.setXTitle(getCurrentMonth());
	...
	//    
	        ...
	        mRenderer2.setXTitle(getCurrentMonth());
	...
	//    
	        ...
	        mRenderer3.setXTitle(getCurrentMonth());
	        mRenderer3.setYTitle("Calories");
	        mRenderer3.setZoomButtonsVisible(false);    mRenderer.setShowLegend(true);
	...
	//    
	    ...
	    (LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
	        mChartView2 = ChartFactory.getBarChartView(this, dataSet2, mRenderer2, Type.DEFAULT);
	        layout2.addView(mChartView2, new LayoutParams
	    (LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
	        mChartView3 = ChartFactory.getBarChartView(this, dataSet3, mRenderer3, Type.DEFAULT);
